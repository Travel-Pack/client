...
export default function TravelStep() {
  ...
  const destinationsByCity = useSelector(
    (state) => state.destinations.destinationsByCity
  )
    ...
    <div className="overflow-hidden">
      <div className="flex flex-col xl:flex-row ease-in-out h-screen">
        <div
          ...
          <section className="w-full h-full gap-7 flex flex-col inside-container absolute items-center justify-center inset-0">
            <div
              onClick={() => {
                setTopText(false), setShowDest(false)
              }}
              className="text-white cursor-pointer border-b-4 border-white text-center text-6xl">
              <h1 className="font-semibold">Preparing</h1>
              <h1 className="font-light">
                the next <span className="font-semibold">Travel</span> 
              </h1>
            </div>
            <div
              className={`flex flex-col gap-10 max-w-3xl text-center bg-black h-fit bg-opacity-60  px-5 ${
                topText ? "" : ""
              }`}>
              <div>
                <label
              ...
              <div className="flex flex-col gap-2">
                ...
                <label htmlFor="rangeDest" className="block mb-1 font-medium text-xl text-white mx-auto">
                  Allocation
                </label>
                <input
                  id="rangeDest"
                  ...
                  className="w-full mx-auto h-2 bg-white rounded-lg appearance-none cursor-pointer"
                />
              </div>
