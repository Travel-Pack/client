...
export default function TravelItenerary() {
  ...
  return (
    <>
      <div className="bg-[url('https://img.freepik.com/free-vector/abstract-background-with-squares_23-2148995948.jpg?w=1800&t=st=1673367124~exp=1673367724~hmac=1eb149ec475353213df55a1a7d2aadbdc30131bbe9b4cffee40a80fd132a2ece')] bg-cover bg-fixed mb-10">
