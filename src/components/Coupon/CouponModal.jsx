...
export default function CouponModal({ point }) {
  ...
  return (
    <>
      <button
        className="inline-block shrink-0 rounded-md mx-auto bg-yelloku px-12 py-3 font-medium  hover:bg-black hover:text-yelloku duration-200 my-5"
        type="button"
      ...
      {showModal ? (
        <>
          <div
            className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none my-10"
            ...
            <div className="relative w-auto my-6 mx-auto max-w-6xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {/*body*/}
                <div
                  className="relative p-6 grid grid-cols-2 overflow-auto"
                  ...
                  {point == 0 ? (
                    <h1>
                      You don't have any coupon yet, start your journey in our forum or
                      review!
                    </h1>
                  ) : null}
                </div>
